      ...
      <div className="relative p-4 max-h-full mx-auto" style={{ maxWidth: '720px' }}>
        <div className="relative rounded-lg shadow bg-gray-700">
          <div className="flex items-center justify-between p-4 md:p-5 rounded-t pb-0">
            ...
            <button type="button" className="self-start text-gray-400 bg-transparent rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-start  hover:text-white" onClick={() => { onCancel(); }}>
              <UilTimes />
